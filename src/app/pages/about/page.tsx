      ...
      <main className="w-3/4 space-y-8">
        ...
        <section id="about-cribr" tabIndex={-1}>
          <p className="mb-4 text-lg">
            ...
            . It actually started out as a personal app (Python based) that I had built to help me extract contents from YouTube videos, which I then used to train ML models.
          </p>
          <p className="mb-4 text-lg">
